...
<meta charset="UTF-8">
<link
	href="<%=request.getContextPath()%>/style/assets/css/stylePagePayment.css"
	rel="stylesheet" />
...
DecimalFormat vndFormat = new DecimalFormat("#,##0", symbols);
String formattedTotal = vndFormat.format(totalAmount) + " ₫";
%>
</head>
<body>
			...
			<div class="front">
				...
				<svg version="1.1" id="cardfront" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <g id="Front">
                        ...
                        <text
						transform="matrix(1 0 0 1 54.1074 389.8793)" class="st7 st5 st8">tên chủ thẻ</text>
                        <text
						transform="matrix(1 0 0 1 479.7754 388.8793)" class="st7 st5 st8">ngày phát hành</text>
                        <text transform="matrix(1 0 0 1 65.1054 241.5)"
						class="st7 st5 st8">số thẻ</text>
                        <g>
                            <text
			...
			<div class="back">
				<svg version="1.1" id="cardback" xmlns="http://www.w3.org/2000/svg"
                    ...
                    C707.1,246.4,704.4,249.1,701.1,249.1z" />
                        ...
                        <g class="st8">
                            <text
						transform="matrix(1 0 0 1 518.083 280.0879)" class="st9 st6 st10">CSC</text>
                        </g>
	...
	<div>
		<form class="form-container" id="customForm" method="post"
			action="<%=request.getContextPath()%>/Trangchu/Payment">
			<div class="field-container">
				<label for="name">Tên chủ thẻ</label> <input id="name" name="name"
			...
			<div class="field-container">
				<label for="phone">Số điện thoại</label> <input id="phone"
					name="phone" type="text" value="<%=phoneNumber%>">
			</div>
			<div class="field-container">
				<label for="cardnumber">Số thẻ</label><span id="generatecard">thẻ
					ngẫu nhiên</span> <input id="cardnumber" type="text" inputmode="numeric">
			...
			<div class="field-container">
				<label for="expirationdate">Tháng/Năm phát hành (mm/yy)</label> <input
					id="expirationdate" type="text" inputmode="numeric">
			</div>
			<div class="field-container">
				<label for="securitycode">CSC</label> <input id="securitycode"
					type="text" inputmode="numeric">
			</div>
			<div class="field-container">
    <label for="money">Số tiền (VND)</label> 
    <input id="money" name="money" type="text" value="<%=formattedTotal%>">
</div>
			<div class="field-container">
				<button class="button" type="submit">
					<span class="submit">Thanh toán</span> <span class="loading"><i
	...
	<script type="text/javascript"
		src="<%=request.getContextPath()%>/style/assets/js/js-pagePayment.js"></script>
	<script
		src="<%=request.getContextPath()%>/style/assets/js/simple.money.format.js"></script>
	<script type="text/javascript">
   ...
   button.addEventListener('click',()=>{ setTimeout(submitForm, 5000);});
